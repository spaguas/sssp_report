...
st.title("Interpolação Personalizada")
...
st.write("Data e Hora Selecionadas:", data_hora_inicial)
...
horas = st.number_input("Quantidade de horas para acumulação de chuva:", min_value=1, max_value=500, value=2)
...
titulo = f"Acumulado de chuvas de {data_inicial_str} à {datetime.now().strftime('%Y-%m-%d')}"
